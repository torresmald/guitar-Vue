...
defineEmits(["sumar-carrito", "restar-carrito", "eliminar-carrito", "agregar-carrito", "vaciar-carrito"]);
        ...
        <div class="container-xl">
                                        ...
                                        <tr>
                                            ...
                                            <td class="flex align-items-start gap-4">
                                                <button
                                                    type="button"
                                                    class="btn btn-dark"
                                                    @click="$emit('restar-carrito', guitarra)"
                                                >
                                                    -
                                                </button>
                                                    {{ guitarra.cantidad }}
                                                <button
                                                    type="button"
                                                    class="btn btn-dark"
                                                    @click="$emit('sumar-carrito', guitarra)"
                                                >
                                                    +
                                                </button>
                                            </td>
                                            <td>
                                                <button
                                                    ...
                                                    type="button"
                                                    @click="$emit('eliminar-carrito', guitarra)"
                                                >
                                                    X
                                                </button>
                                            </td>
            ...
            <div class="row mt-5">
                <div class="col-md-6 text-center text-md-start pt-5">
                    <h1 class="display-2 fw-bold">{{guitarraHeader.nombre}}</h1>
